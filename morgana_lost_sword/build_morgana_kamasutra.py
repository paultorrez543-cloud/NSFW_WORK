...
# Dedicated builder for Morgana Kamasutra workflow
...
def build():
    ...
    wf = generate_kamasutra_workflow("morgana_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_morgana_kamasutra.json")
