...
# Dedicated builder for Claire Manual ControlNet workflow
...
def build():
    ...
    wf = generate_manual_controlnet_workflow("claire_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_claire_manual_controlnet.json")
