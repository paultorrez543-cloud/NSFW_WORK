...
# Dedicated builder for Claire Kamasutra BBC Interracial workflow
...
def build():
    ...
    wf = generate_kamasutra_interracial_workflow("claire_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_claire_kamasutra_bbc.json")
