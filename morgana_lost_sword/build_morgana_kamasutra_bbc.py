...
# Dedicated builder for Morgana Kamasutra BBC Interracial workflow
...
def build():
    ...
    wf = generate_kamasutra_interracial_workflow("morgana_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_morgana_kamasutra_bbc.json")
