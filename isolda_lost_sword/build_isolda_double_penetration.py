...
# Dedicated builder for Isolda Double Penetration (DP) workflow
...
def build():
    ...
    wf = generate_dp_manual_workflow("isolda_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_isolda_double_penetration.json")
