...
# Dedicated builder for Isolda Kamasutra BBC Interracial workflow
...
def build():
    ...
    wf = generate_kamasutra_interracial_workflow("isolda_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_isolda_kamasutra_bbc.json")
