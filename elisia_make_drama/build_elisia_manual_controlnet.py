...
# Dedicated builder for Elisia Manual ControlNet workflow
...
def build():
    ...
    wf = generate_manual_controlnet_workflow("elisia_make_drama", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_elisia_manual_controlnet.json")
