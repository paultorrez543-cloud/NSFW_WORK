...
# Dedicated builder for Marcia Kamasutra BBC Interracial workflow
...
def build():
    ...
    wf = generate_kamasutra_interracial_workflow("marcia_make_drama", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_marcia_kamasutra_bbc.json")
