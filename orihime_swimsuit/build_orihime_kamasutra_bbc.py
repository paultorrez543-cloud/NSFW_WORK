...
# Dedicated builder for Orihime Kamasutra BBC Interracial workflow
...
def build():
    ...
    wf = generate_kamasutra_interracial_workflow("orihime_swimsuit", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_orihime_kamasutra_bbc.json")
