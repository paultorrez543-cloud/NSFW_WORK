...
# Dedicated builder for Orihime Manual ControlNet workflow
...
def build():
    ...
    wf = generate_manual_controlnet_workflow("orihime_swimsuit", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_orihime_manual_controlnet.json")
