...
# Dedicated builder for Morgana Manual ControlNet workflow
...
def build():
    ...
    wf = generate_manual_controlnet_workflow("morgana_lost_sword", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_morgana_manual_controlnet.json")
