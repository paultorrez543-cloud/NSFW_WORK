...
# Dedicated builder for Elisia Double Penetration (DP) workflow
...
def build():
    ...
    wf = generate_dp_manual_workflow("elisia_make_drama", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_elisia_double_penetration.json")
