...
# Dedicated builder for Marcia Kamasutra workflow
...
def build():
    ...
    wf = generate_kamasutra_workflow("marcia_make_drama", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_marcia_kamasutra.json")
