...
# Dedicated builder for Elisia Kamasutra workflow
...
def build():
    ...
    wf = generate_kamasutra_workflow("elisia_make_drama", char_cfg)
    out_path = os.path.join(os.path.dirname(__file__), "workflow_elisia_kamasutra.json")
